function txt() {
    let avatar = "https://api.minimalavatars.com/avatar/random/svg"
    ...
    document.getElementById("imgalien").src = avatar;
...
function txt2(){
    let p1 = random(100)
    let p2 = random(100-p1)
    let p3 = random(100-(p1+p2))
    let p4 = random(100-(p1+p2+p3))
    let p5 = random(100-(p1+p2+p3+p4))
    let p6 = random(100-(p1+p2+p3+p4+p5))
    let p7 = random(100-(p1+p2+p3+p4+p5+p6))
    let p8 = random(100-(p1+p2+p3+p4+p5+p6+p7))
    let p9 = random(100-(p1+p2+p3+p4+p5+p6+p7+p8))
    let raz = ["Humano", "Legum", "Compunivy", "Dios", "Piorodo", "Comedor de Almas", "FEx-9000", "Spacialdino", "Weruga"]
    ...
    let razimg=["https://www.thoughtco.com/thmb/t4p8KVtdkuH6eLWf_c-cB-gjAZo=/2937x2937/smart/filters:no_upscale()/Zenobia-486776647x-56aa25675f9b58b7d000fd07.jpg","https://laragd.com/45-large_default/mandragora.jpg","http://2.bp.blogspot.com/_ukmdk999R0U/SsnLn4cXBTI/AAAAAAAAABQ/UgBvdN1Fj8U/s320/coloso.jpg","https://gluc.mx/u/fotografias/m/2020/8/26/f850x638-32257_109746_5050.jpg","https://wallpaperaccess.com/full/6629154.jpg","https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTS0BAuymH7qmtW1OEshpwxNXgz-hOtKgbxYcqDTyvVzUeQxMd5xW9fcBODnI2WfUhsHoE&usqp=CAU","https://pbs.twimg.com/media/DSndDEtXUAA9iDg.jpg","https://i.pinimg.com/originals/05/1e/f6/051ef69f88d2b77ed3636ba521bb86a8.jpg","https://preview.redd.it/l59kzfk346v61.jpg?width=640&crop=smart&auto=webp&s=9cff6d85bd7f43d7e840fef95aaa5fd57bfb3b81"]
    let ini;
    let ino;
    let inu;
    if(raz[0] == "Humano"){
    ...
    if(raz[0] == "Comedor de Almas"){
        ini = 5
    }
    if(raz[0] == "FEx-9000"){
        ini = 6
    }
    if(raz[0] == "Spacialdino"){
        ini = 7
    }
    if(raz[0] == "Weruga"){
        ini = 8
    ...
    if(raz[1] == "Comedor de Almas"){
        ino = 5
    }
    if(raz[1] == "FEx-9000"){
        ino = 6
    }
    if(raz[1] == "Spacialdino"){
        ino = 7
    }
    if(raz[1] == "Weruga"){
        ino = 8
    ...
    if(raz[2] == "Comedor de Almas"){
        inu = 5
    }
    if(raz[2] == "FEx-9000"){
        inu = 6
    }
    if(raz[2] == "Spacialdino"){
        inu = 7
    }
    if(raz[2] == "Weruga"){
        inu = 8
    ...
    document.getElementById("dios").innerHTML = ps[5] + "%"
    document.getElementById("compunivy").innerHTML = ps[4] + "%"
    document.getElementById("spacialdino").innerHTML = ps[3] + "%"
